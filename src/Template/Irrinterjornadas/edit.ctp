...
<div class="irrinterjornadas form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Editar Irregularidade Interjornadas '. $funcionario['nome']) ?></legend>
        <div class="large-3 medium-4 columns">
            <?php
            $data = substr($irrinterjornada->data, -4)."-".substr($irrinterjornada->data, 3, 2)."-".substr($irrinterjornada->data, 0, 2);
