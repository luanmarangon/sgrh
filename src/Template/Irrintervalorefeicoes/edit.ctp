...
<div class="irrintervalorefeicoes form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Editar Intervalo de Refeição '. $funcionario['nome']) ?></legend>
        <div class="large-4 medium-4 columns">
            <?php
            $data = substr($irrintervalorefeico->data, -4)."-".substr($irrintervalorefeico->data, 3, 2)."-".substr($irrintervalorefeico->data, 0, 2);
